...
{
    if (value < static_cast<int>(PacketType::SYN) ||
        value > static_cast<int>(PacketType::DATA_ACK)) {
...
struct Packet {
    ...
    std::string serialize() const
    {
        ...
        oss << static_cast<int>(type) << "|" << seq << "|" << ack << "|"
            << window << "|" << payload;
        return oss.str();
    }
...
inline std::string to_string(PacketType type)
{
    ...
    case PacketType::FILE_DATA:
        return "FILE_DATA";
    case PacketType::FILE_ERR:
        return "FILE_ERR";
    case PacketType::FILE_END:
        return "FILE_END";
    case PacketType::EXPR_REQ:
        return "EXPR_REQ";
    case PacketType::EXPR_RES:
        return "EXPR_RES";
